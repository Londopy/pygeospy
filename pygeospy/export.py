...
def interactive_map(
    result: GeoResult,
    output_path: str = "pygeospy_map.html",
...
<title>pygeospy Analysis Report</title>
<style>
...
<body>
<h1>🔍 pygeospy Analysis Report</h1>
...
<hr><p style="color:#888;font-size:.8rem">Generated by pygeospy v0.2 · github.com/Londopy/pygeospy</p>
</body></html>"""


def html_report(result: GeoResult, output_path: str = "pygeospy_report.html") -> str:
...
def markdown_report(result: GeoResult, output_path: str = "pygeospy_report.md") -> str:
    """Generate a Markdown intelligence summary."""
    lines = [
        "# pygeospy Analysis Report",
