...
def test_search_grid_returns_features():
    from geoint.sar import search_grid
...
def test_corridor_search_segments():
    from geoint.sar import corridor_search
...
def test_poa_zones_ring_count():
    from geoint.sar import poa_zones
...
def test_lost_person_radius_hiker():
    from geoint.sar import lost_person_radius
...
def test_expanding_square_waypoint_count():
    from geoint.sar import expanding_square
