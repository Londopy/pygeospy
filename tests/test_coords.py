...
def test_destination_north():
    from geoint.coords import destination, haversine
    origin = (0.0, 0.0)
...
def test_midpoint_equator():
    from geoint.coords import midpoint, haversine
...
def test_dd_to_dms_positive():
    from geoint.coords import dd_to_dms
...
def test_dms_roundtrip():
    from geoint.coords import dd_to_dms, dms_to_dd
    original = -33.8688
...
def test_utm_zone_london():
    from geoint.coords import latlon_to_utm
...
def test_batch_haversine():
    from geoint.coords import batch_haversine, haversine
    origin = (51.5, -0.1)
