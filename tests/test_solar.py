...
def test_solar_elevation_noon_equator_equinox():
    ...
    """
    from geoint.solar import solar_elevation
...
def test_solar_azimuth_noon_northern():
    ...
    from geoint.solar import solar_azimuth, solar_noon_utc
...
def test_shadow_azimuth_opposite_sun():
    ...
    from geoint.solar import shadow_azimuth
...
def test_shadow_length_ratio_inverse_elevation():
    ...
    from geoint.solar import shadow_length_ratio
...
def test_elevation_from_shadow_roundtrip():
    ...
    from geoint.solar import shadow_length_ratio, elevation_from_shadow
...
def test_sunrise_sunset_tropical():
    ...
    from geoint.solar import sunrise_sunset
...
def test_season_from_shadow_ratio():
    ...
    from geoint.solar import season_from_shadow
